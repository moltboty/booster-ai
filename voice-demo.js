  ...
  function el(tag, attrs = {}, children = []) {
    ...
    function createWidget() {
          ...
          const transcript = el("p", { className: "voice-demo-transcript", id: "voice-demo-transcript" }, [
                  "اضغط تحدث واسأل عن Booster AI.",      [el("span", { className: "voice-demo-btn-label" }, ["تحدث / Talk"])]
                );
        ...
        async function speak(ui, text, lang) {
              ...
              try {
                      ...
                      if (res.ok) {
                                ...
                                const url = URL.createObjectURL    if ("speechSynthesis" in window) {
                  ...
                  function stopListening(ui) {
                        ...
                        if (recognition) {
                                try {
                                          recognition.stop();    recognition.interimResults = false;
