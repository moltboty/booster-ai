...
A research-led, responsive front-end for Booster AI: an interview-led AI consultancy that finds operational friction and delivers suitable agents and automation.
...
- `DECISION.md` — design, stack, motion, and integration decisions
- `ACCEPTANCE.md` — release criteria
- `QA.md` — executed verification evidence
