(() => {
  const translations = {
    ar: {
      ...
      'home.workflowA11yTitle': 'سير العمل التوضيحي',
      'home.workflowVisualLabel': 'سير عمل توضيحي يبدأ بالإشارات التشغيلية ويمر بالتشخيص والتنفيذ المترابط والمراجعة البشرية وصولا إلى تحسين قابل للقياس',
      'home.workflowSvgTitle': 'سير عمل Booster AI',
      'home.workflowSvgDesc': 'تتجمع الإشارات التشغيلية في هدف واضح، ثم تنتقل عبر مكونات تنفيذ مترابطة بموافقة بشرية، لتنتج تحسنا قابلا للقياس.',
      'visual.signalsClarity': 'الإشارات تصبح وضوحا',
      'visual.clarity': 'الوضوح',
      'visual.connectedDelivery': 'تنفيذ مترابط',
      'visual.humanCheckpoint': 'مراجعة بشرية',
      'visual.measuredImprovement': 'تحسين قابل للقياس',
      'visual.signalsBecomeClarity': 'الإشارات تصبح وضوحا',
      'visual.humanBuiltIn': 'قرارات بشرية مدمجة',
      'visual.timeEfficiencyValue': 'الوقت والكفاءة والقيمة',
    ...
    en: {
      ...
      'home.workflowA11yTitle': 'Illustrated workflow',
      'home.workflowVisualLabel': 'Illustrated workflow from organizational signals through diagnosis, connected delivery and human review to measured improvement',
      'home.workflowSvgTitle': 'Booster AI workflow',
      'home.workflowSvgDesc': 'Operational signals converge into a clarity target, move through connected implementation components with human approval, then produce measured improvement.',
      'visual.signalsClarity': 'Signals become clarity',
      'visual.clarity': 'CLARITY',
      'visual.connectedDelivery': 'CONNECTED DELIVERY',
      'visual.humanCheckpoint': 'HUMAN CHECKPOINT',
      'visual.measuredImprovement': 'MEASURED IMPROVEMENT',
      'visual.signalsBecomeClarity': 'Signals become clarity',
      'visual.humanBuiltIn': 'Human decisions built in',
      'visual.timeEfficiencyValue': 'Time, efficiency and value',
